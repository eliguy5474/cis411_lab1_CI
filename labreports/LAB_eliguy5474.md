...
```
elijahmurray@Elijahs-MBP cis411_lab1_CI % git log --oneline 
8f7696b (HEAD -> labreport) your commit and reference @trevordbunch in the message
...
The code is able to be intergrated into a program   
